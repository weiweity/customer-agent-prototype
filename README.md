...
| 核对登录窗飞书改系统浏览器、账号仍本窗（how-to D1；已合入 v0.3.4，仍 mock） | [如何验证 · D1](docs/how-to-verify-desktop.md#合成产品会话接入d1) · [2026-09-18 规格](docs/plans/2026-09-18-login-environment-and-ui.md) |
...
| 身份代理：飞书 + 账号都走 OIDC broker（Logto），产品只做 RP | [docs/plans/2026-09-18-identity-broker.md](docs/plans/2026-09-18-identity-broker.md) · [本机 how-to](docs/how-to-identity-broker-mac.md) |
